              ...
              <div className="pt-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {githubUrl && (
                    ...
                    >
                      <Github size={13} /> GitHub <ExternalLink size={10} className="text-muted-foreground" />
                    </a>
                  )}
                  {linkedinUrl && (
                    <a
                    ...
                    >
                      <Linkedin size={13} /> LinkedIn <ExternalLink size={10} className="text-muted-foreground" />
                    </a>
                  )}
                  {portfolioUrl && (
                    <a
